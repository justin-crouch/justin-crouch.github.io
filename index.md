...
## Project Overview
[This portfolio](/Web-Artifact) is the capstone of my Computer Science undergraduate degree at Southern New Hampshire University. It contains enhancements of an artifact from the [*CS 360: Mobile Architecture and Programming*](/Android-Artifact.zip). Specifically, the artifact is an Android mobile application designed to help a fictional company in managing their warehouse inventory. Its selection was due to its full-stack development, which aligns well with my full-stack development career goal.
...
At a high level, [the artifact](/Android-Artifact.zip) has been transitioned from an Android-only application to a web-based application. Not only was the technology stack updated to support this change, but the software architecture was improved as well. Usability features, such as searching for specific items in the inventory, has been integrated into the project, which were lacking in the [original artifact](/Android-Artifact.zip). A review of the artifact and its planned enhancements can be viewed in the video below.
...
[This enhancement](/Web-Artifact) showcases my skills in UI/UX design, code organization, and the ability to utilize industry standard tools, such as Git for version control and Vue.js for front-end development.

At a consumer level, [the artifact](/Android-Artifact.zip) was improved in its UI and UX. Before, [the artifact](/Android-Artifact.zip) had a clunky and confusing UI that was only viewable on mobile Android devices. Now, the UI has a mobile-first design that supports tablet- and desktop-sized screens, whose elements can be interacted with using the keyboard for accessibility.

At a developer level, [the artifact](/Android-Artifact.zip) was improved in its code structure. Before, the code was vaguely separated into a UI and data layer with non-descriptive variable naming. Now, [the project](/Web-Artifact) follows the MVVM pattern, which uses Vue.js as the View-Model for more efficient development, Vue.js’ concept of Single-File Components for the [View](/Web-Artifact/src/components) ([Single-File Components](https://vuejs.org/guide/scaling-up/sfc.html), 2026), and Pinia for the [Model](/Web-Artifact/src/store/inventory/inventoryStore.js) ([Pinia](https://pinia.vuejs.org/), 2026).
...
The test-driven development technique was used to develop [this enhancement](/Web-Artifact/src/modules). Specifically, I learned how to design appropriate [unit tests](/Web-Artifact/src/__tests__) with the Vitest tool to guide the implementation of the Prefix Tree. The greatest challenge was integrating the Prefix Tree into the actual application, mainly due to how Vue.js binds the Model and View layers during runtime. However, using integration tests could have lowered the challenge.

## Database
The [final enhancement](/Web-Artifact/src/store/inventory) of this artifact showcases my skills in database design and data management. The [original artifact](/Android-Artifact.zip) used SQLite as its database management system and defined data models so to seamlessly interact between the database and business logic. However, the original codebase was never systematically tested, meaning that its current logic could break in edge-cases or with future features.

With [this enhancement](/Web-Artifact/src/store/inventory), the data models and business logic have associated [unit tests](/Web-Artifact/src/__tests__), which reduces the likelihood of flaws currently existing or being produced in the future. Since the [original artifact](/Android-Artifact.zip) has been translated from an Android application to a web-based application, [this enhancement](/Web-Artifact/src/store/inventory) utilizes a NoSQL object database management system present in all major browsers, namely IndexedDB.
